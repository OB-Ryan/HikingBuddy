...
## Introduction
Hiking is a great way to get outside, clear your mind, get exercise, and connect with nature. However, hikers can face real safety concerns when conditions are not ideal. High temperatures can lead to heat exhaustion, and high UV/sun levels can lead to sunburns. HikingBuddy offers a solution to these concerns. Using an Adafruit Flora microcontroller, HikingBuddy provides live information about temperature and light conditions, allowing users to make more informed decisions before and during their outdoor adventures. The HikingBuddy attaches to your backpack strap so the state of conditions is easy to see. A green light means conditions are optimal, yellow means sub-optimal, and red means unfavorable. For example, a red temperature reading may be a sign to take a break in the shade, hydrate, or turn around entirely. Because every hiker has different physical limits and every trail has different conditions, HikingBuddy allows users to fully customize the threshold ranges to suit their personal preferences, comfort level, and environment, allowing them to make safer, more informed decisions on the trail.
